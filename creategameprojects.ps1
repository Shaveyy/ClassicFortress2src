...
$path = "C:\Users\pokeg\Desktop\classic tf2\CFDev"

# Boot arguments
$hl2exe = Join-Path $path hl2.exe 
$hl2args = "-game classic -window -w 1600 -h 900 -novid +developer 2 -console -mapping"

$momentum_sym = Join-Path $path classic # Writing as (steamworks path)/momentum
$momentum = [System.IO.Path]::GetFullPath("..\game\tf_mod") # This is your local dev folder
