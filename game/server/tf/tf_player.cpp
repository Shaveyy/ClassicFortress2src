...
{
	// non-efficient method of precaching, but idc. :P
...
void CTFPlayer::Spawn()
{
	...
	case TF_CLASS_SNIPER:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_sniper_arms.mdl");
		break;
	case TF_CLASS_SOLDIER:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_soldier_arms.mdl");
		break;
	case TF_CLASS_PYRO:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_pyro_arms.mdl");
		break;
	case TF_CLASS_MEDIC:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_medic_arms.mdl");
		break;
	case TF_CLASS_DEMOMAN:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_demo_arms.mdl");
		break;
	case TF_CLASS_HEAVYWEAPONS:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_heavy_arms.mdl");
		break;
	case TF_CLASS_SPY:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_spy_arms.mdl");
		break;
	case TF_CLASS_ENGINEER:
		GetViewModel(1)->SetModel("models/weapons/c_models/c_engineer_arms.mdl");
		break;
	}
...
void CTFPlayer::Regenerate( void )
{
	...
	if (m_Shared.InCond(TF_COND_POISONED))
	{
		m_Shared.RemoveCond(TF_COND_POISONED);
	}
}
