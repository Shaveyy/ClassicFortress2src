...
ConVar  cl_renderhands("cl_renderhands", "1", FCVAR_REPLICATED, "When true, render player hands (Turn off for better performance).");
...
{
	if(cl_renderhands.GetInt() == 1) // check if we are allowed to render hands
	CreateHandModel();
